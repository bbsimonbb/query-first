namespace QueryFirst
{
    ...
    public interface IWrapperClassMaker
    {
        ...
        string MakeExecuteScalarWithConnUsingProps(ICodeGenerationContext ctx);
        string MakeExecuteScalarWithoutConnUsingProps(ICodeGenerationContext ctx);
        ...
        string MakeExecuteNonQueryWithConnUsingProps(ICodeGenerationContext ctx);
        string MakeExecuteNonQueryWithoutConnUsingProps(ICodeGenerationContext ctx);
        string MakeExecuteWithConn(ICodeGenerationContext ctx);
        string MakeExecuteWithoutConn(ICodeGenerationContext ctn);
        string MakeExecuteWithConnUsingProps(ICodeGenerationContext ctx);
        string MakeExecuteWithoutConnUsingProps(ICodeGenerationContext ctn);
        string MakeGetOneWithConn(ICodeGenerationContext ctx);
        string MakeGetOneWithoutConn(ICodeGenerationContext ctx);
        string MakeGetOneWithConnUsingProps(ICodeGenerationContext ctx);
        string MakeGetOneWithoutConnUsingProps(ICodeGenerationContext ctx);
